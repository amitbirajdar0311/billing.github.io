...
$insertData = "INSERT INTO invoice_form (companySelect, invoiceDate, invoiceNumber, requestId, selectedCompanyAddress, bookedBy, passengerName, fromD, toD, car, Vno, selectedDuty, rateofduty, dutyAmt, uploadDuty, extHrs, myQty, extHAmt, exKm, extKms, extKAmt, pnt, nightAllow, totalAmount) VALUES ('$companySelect','$invoiceDate','$invoiceNumber','$requestId','$selectedCompanyAddress','$bookedBy','$passengerName','$fromD','$toD','$car','$Vno','$selectedDuty','$rateofduty','$dutyAmt','$uploadDuty','$extHrs','$myQty','$extHAmt','$exKm','$extKms','$extKAmt','$pnt','$nightAllow','$totalAmount')";
