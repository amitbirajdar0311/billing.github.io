		...
		<tbody>
			...
			<tr style="background: 255 255 255">
				...
				<td>
					...
					<input type="text" name="passengerName" id="passengerName" placeholder="Enter Passenger Name" />
				</td>
				<td></td>
				<td></td>
				<td></td>
			...
			<tr style="background: 255 255 255">
				...
				<td>
					...
					<input type="text" name="Vno" id="Vno" placeholder="Enter a Vehicle Number" />
				</td>
				<td id="rateColumn"></td>
				<td></td>
				<td></td>
			...
			<tr>
				...
				<td >
					...
					<input type="text" id="outStationInput" placeholder="Enter Out Station" style="display: none; ">
			...
			<tr>
			 ...
			 <input type="file" placeholder="upload" name="uploadPaT" class="upload" id="uploadPaT">
				...
				<td></td>
				<td>
					<input type="text" name="pnt" value = "0" placeholder="Enter AMOUNT" id="pnt" />
				</td>
			</tr>
			<tr>
				<td>9</td>
			...
			<tr>
				...
				<td></td>
				<td></td>
				<td><input type="text" name="totalAmount" id="totalAmount" value="0" ></td>
			</tr>
